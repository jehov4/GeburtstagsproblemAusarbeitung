...
Die höchste Wahrscheinlichkeit dafür, dass die 1. Kollision genau bei k auftritt liegt auf der Erde bei \bm{$\sim 20,105$} (zu sehen auf Grafik \ref{num.fpeqe}), auf dem Mars bei \bm{$\sim 28,928$} und auf dem Jupiter bei \bm{$\sim 66,803$} also jeweils bei \bm{$1 + \sqrt{n}$}.
